...
\begin{figure}
	...
	\caption{Illustration of magnetic impurities in a kagome lattice;
        {\color{red} figure should be modified}. In Mn$_{3+x}$Sn$_{1-x}$, this
        could correspond to substitutional impurities.}
	\label{fig:kagome21}
\end{figure}
