...
Employing the symmetry analysis using the \textit{Symmetr} code~\cite{Symmetr}, we find that the fully compensated Mn$_3$Sn configuration exhibits $60^\circ$ and $120^\circ$ real-space rotation symmetry, while the tilted configurations {\color{blue} (see Fig.~\ref{fig:fs-rotation})} break both.
...
\begin{figure}
	...
	\caption{Illustration of unaligned magnetic impurities (black) in a kagome lattice. In Mn$_{3+x}$Sn$_{1-x}$, this could correspond to substitutional impurities.}
	\label{fig:kagome21}
\end{figure}
