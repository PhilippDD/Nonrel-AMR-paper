...
\date{May28, 2025 + remarks from a phone call with J\v Z}
...
{\color{red} Should Fig.~\ref{fig:fs-rotation} stay or go?} Proposing
an experiment 'in real material' may be tricky because details of the
...
\begin{figure}
\caption{New fig. 9 should contain scatt. rates on FS {\color{red} (see mails on May28)}.}
\label{fig-09}
\end{figure}
...
a triangular or square FM lattice?
